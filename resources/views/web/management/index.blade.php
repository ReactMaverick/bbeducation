            ...
            <div class="modal-body">
                ...
                <div class="modal-input-field-section">
                    <div class="row">
                                    ...
                                    <div class="finance-list-text new_scrollbar">
                                        <table class="table table-bordered table-striped" id="">
                                            ...
                                            <tbody class="table-body-sec" id="studentTbody">
                                                ...
                                                <tr class="school-detail-table-data selectStudentRow" id="selectStudentRow{{ $student->student_id }}" studentId="{{ $student->student_id }}" firstName="{{ $student->firstName_txt }}" surname="{{ $student->surname_txt }}" isCurrent="{{ $student->isCurrent_ysn }}">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 col-sm-12">
                            <form action="{{ url('/studentInsert') }}" method="post" class="form-validate" id="studentAddForm">
                                @csrf
                                <div class="modal-input-field form-group">
                                    <label class="form-check-label">First Name</label>
                                    <input type="text" class="form-control field-validate" name="firstName_txt" id="firstName_txt" value="">
                                </div>

                                <div class="modal-input-field form-group">
                                    <label class="form-check-label">Surname</label>
                                    <input type="text" class="form-control field-validate" name="surname_txt" id="surname_txt" value="">
                                </div>
                    ...
                    <div class="modal-input-field-section">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modal-input-field form-group">
                                    <label class="form-check-label">First Name</label>
                                    <input type="text" class="form-control field-validate-2" name="firstName_txt" id="firstNameEdit" value="">
                                </div>

                                <div class="modal-input-field form-group">
                                    <label class="form-check-label">Surname</label>
                                    <input type="text" class="form-control field-validate-2" name="surname_txt" id="surnameEdit" value="">
                                </div>

                                <div class="modal-side-field">
                                    <label class="form-check-label" for="CurrentId">Current</label>
                                    <input type="checkbox" class="" name="isCurrent_ysn" id="CurrentId" value="1">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="modal-input-field">
                                    ...
                                    <input type="text" class="form-control datePickerPaste" name="start_date" id="metricStartDate" value="{{ date('d/m/Y', strtotime($startOfMonth)) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="modal-input-field">
                                    <label class="form-check-label">End Date</label>
                                    <input type="text" class="form-control datePickerPaste" name="end_date" id="metricEndDate" value="{{ date('d/m/Y', strtotime($endOfMonth)) }}">
                                </div>
                            </div>
                        </div>
                    </div>
