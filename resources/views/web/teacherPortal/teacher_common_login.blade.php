...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <p class="login-box-msg">COMMON CANDIDATE LOGIN</p>
                ...
                <form method="POST" action="{{ url('/candidate/teacherProcessCommonLogin') }}" class="form-validate">
                    @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            select2Input.select2({
                ...
                ajax: {
                    url: '{{ url('/candidate/fetchTeacherAjax') }}',
                    dataType: 'json',
                    delay: 250, // Delay before sending the request
                    processResults: function(data) {
                        return {
                            results: $.map(data, function(item) {
                                var name = item.firstName_txt + ' ' + item.surname_txt;
                                return {
                                    id: item.teacher_id,
                                    text: name
                                };
