    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="assignment-detail-page-section">
                <div class="row assignment-detail-row mt-3">

                    <div class="col-md-12">

                        {{-- calendar --}}
                        <div class="school-detail-right-sec sec_box_edit">
                            <div class="teacher-calendar-sec5" style="display: block;">
                                        ...
                                        @foreach ($calenderList as $key1 => $calender)
                                            <form action="{{ url('/candidate/logTeacherTimesheetAdd') }}" method="post"
                                                ...
                                                <div class="new_teacher_calendar_outer1">
                                                    ...
                                                    <div class="calendar-section2 row">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            @if ($calender->reject_status == 1)
                                                                <button type="submit"
                                                                    class="btn btn-outline-success mt-3 mr-2 ml_at"
                                                        ...
                                                        @endif --}}
                                                                <button type="submit"
                                                                    class="btn btn-outline-success mt-3 ml_at">Submit
                                                                    Timesheet</button>
                                                            @else
                                                                <button type="button"
                                                                    class="btn btn-secondary ml_at mt-3"
        ...
        <div class="modal-dialog modal-dialog-centered calendar-modal-section">
            <div class="modal-content calendar-modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('/candidate/teacherTimesheetAddNew') }}" method="post"
                        class="form-validate-2" id="eventAddForm">
                        @csrf
    ...
    <script>
        ...
        function calDateClick(type, asnDate_dte, submit_status, reject_status, asn_id, timesheet_item_id, approveStatus,
            ...
            if (approveStatus == 1) {
                ...
                var SITEURL = "{{ url('/') }}";
                $.ajax({
                    url: SITEURL + "/candidate/teacherTimesheetEdit",
                    data: {
                        "_token": "{{ csrf_token() }}",
