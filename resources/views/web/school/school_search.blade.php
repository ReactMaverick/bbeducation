        ...
        <div class="tab-content assignment-tab-content" id="myTabContent">
            <div class="container-fluid">
                <div class="row assignment-detail-row">
                    <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 topbar-sec pt-4">
                        <div class="total-sec">
                                    ...
                                    <div class="row srj_row">
                                        <div class="col-md-12 col-sm-12 col-lg-9 col-xl-9 pr-3">
                                            ...
                                            <div class="school-search-section">
                                                <div class="school-search-field school_sr_box">
                                        ...
                                        <div class="col-md-12 col-lg-3 col-sm-12 col-xl-3 advance-search-col">
                                            <div class="search-form-button">
                                                <button class="btn btn-outline-cool" id="advanceSearch">Advance
                                                    Search</button>
                                            </div>
                                            <form action="{{ url('/school-search') }}" method="get"
                                                ...
                                                <div class="advance-search-filter-section rounded" id="advanceSearchDiv"
                                                    ...
                                                    <div class="form-group filter-form-group">
                                                        ...
                                                        <select class="form-control select2" name="ageRangeId"
                                                            id="ageRangeId" style="width: 100%;">
                                                    ...
                                                    <div class="form-group filter-form-group">
                                                        ...
                                                        <select class="form-control select2" name="schoolTypeId"
                                                            id="schoolTypeId" style="width: 100%;">
                                                            <option value="">Choose one</option>
                                                    ...
                                                    <div class="field-input-field">
                                                        <input type="number" class="form-control" name="booked_day"
                                                            id="booked_day"
                                                            value="{{ app('request')->input('booked_day') }}">
                                                    </div>
