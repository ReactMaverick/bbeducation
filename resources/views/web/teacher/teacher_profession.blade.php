...
@section('content')
                ...
                <div class="school-detail-right-sec">
                    <div class="school-details-first-sec">
                        <div class="details-heading">
                            <h2>Profession</h2>
                            <a data-toggle="modal" data-target="#professionEditModal" style="cursor: pointer;"><i
                    ...
                    <div class="school-details-second-sec">
                        <div>
                            <div class="details-heading">
                                <h2>Interview</h2>
                                <a data-toggle="modal" data-target="#interviewEditModal" style="cursor: pointer;"><i
                                        class="fa-solid fa-pencil"></i></a>
                            </div>
                ...
                <div class="school-detail-right-sec">
                    ...
                    <div class="school-details-contact-second-sec">
                        <div class="contact-heading">
                            ...
                            <div class="contact-icon-sec">
                                <a data-toggle="modal" data-target="#teachingSubjectAddModal" style="cursor: pointer;">
                                    <i class="fa-solid fa-plus"></i>
                                </a>
                                <a style="cursor: pointer;" class="disabled-link" id="editTeachingSubjectBttn">
                    ...
                    <div class="school-details-contact-second-sec">
                        <div class="contact-heading">
                            ...
                            <div class="contact-icon-sec">
                                <a style="cursor: pointer;" class="disabled-link" id="deleteQualificationBttn">
                                    <i class="fa-solid fa-minus"></i>
                                </a>
                                <a data-toggle="modal" data-target="#addTeacherQualificationModal" style="cursor: pointer;">
                                    <i class="fa-solid fa-plus"></i>
                                </a>
                                <a style="cursor: pointer;" class="disabled-link" id="editQualificationBttn">
                                    <i class="fa-solid fa-pencil school-edit-icon"></i>
                                </a>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="teachingSubjectAddModal">
        <div class="modal-dialog modal-dialog-centered calendar-modal-section">
            <div class="modal-content calendar-modal-content" style="width:60%;">
            ...
            <div class="modal-content calendar-modal-content" style="width:100%;">
                ...
                <form action="{{ url('/teacherQualificationUpdate') }}" method="post" class="form-validate-5">
                    ...
                    <div class="modal-input-field-section">
                        ...
                        <input type="hidden" name="teacher_id" value="{{ $teacherDetail->teacher_id }}">
                        <input type="hidden" name="qualification_id" id="teacherQualificationIdEdit" value="">
