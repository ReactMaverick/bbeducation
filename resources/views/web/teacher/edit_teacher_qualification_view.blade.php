<div class="col-md-6">
    <div class="form-group calendar-form-filter">
        ...
        <select class="form-control field-validate-5" name="type_int"  style="width:100%;">
            ...
            @foreach ($typeList as $key1 => $type)
                <option value="{{ $type->description_int }}" {{ $Detail->type_int == $type->description_int ? 'selected' : '' }} >
    ...
    <div class="form-group calendar-form-filter">
        ...
        <select class="form-control field-validate-5" name="subType_int"  style="width:100%;">
            ...
            @foreach ($subTypeList as $key1 => $subType)
                <option value="{{ $subType->description_int }}" {{ $Detail->subType_int == $subType->description_int ? 'selected' : '' }} >
    ...
    <div class="form-group modal-input-field">
        ...
        <input type="text" class="form-control field-validate-5" name="title_txt" id="" value="{{ $Detail->title_txt }}">
    </div>
    ...
    <div class="modal-side-field mb-2">
        ...
        <input type="checkbox" class="" name="givesQTS_status"
            id="givesQTS_status_edit" value="1" {{ $Detail->givesQTS_status == '-1' ? 'checked' : '' }} >
    </div>
</div>
<div class="col-md-6">
    <div class="form-group modal-input-field">
        ...
        <input type="text" class="form-control" name="awardingBody_txt"
            id="" value="{{ $Detail->awardingBody_txt }}">
    </div>

    <div class="form-group modal-input-field">
        <label class="form-check-label">Qualification Date</label>
        <input type="date" class="form-control" name="qualified_dte" id="" value="{{ $Detail->qualified_dte }}">
    </div>
</div>