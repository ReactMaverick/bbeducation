                        ...
                        <div class="row my_row_gap">
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 col-sm-12">
                                <div class="school-detail-right-sec">
                                    <div class="school-details-first-sec sec_box_edit">
                                        <div class="details-heading">
                                            <h2>Payroll</h2>
                                            <a data-toggle="modal" data-target="#editPayrollModal" style="cursor: pointer;"
                                ...
                                <div class="payroll-bottom-text">
                                    <p>Details of payments will be released once the invoicing and payroll elements are
                                        complete.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group modal-input-field">
                                        ...
                                        <input type="text" class="form-control" name="NINumber_txt" id=""
                                            value="{{ $teacherDetail->NINumber_txt }}">
                                    </div>
                                ...
                                <div class="col-md-6 modal-form-right-sec">
                                    ...
                                    <div class="form-group modal-input-field">
                                        ...
                                        <input type="text" class="form-control numberField" name="basePayRate_dec"
                                            id="" value="{{ $teacherDetail->basePayRate_dec }}">
                                    </div>
