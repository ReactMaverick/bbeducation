                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td style="padding: 10px 20px;width:33.33%; text-align: right;">
                                <p style="color: #888; font-size: 25px;">New Admin User</p>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding: 10px 20px;">
                                ...
                                <p>Congratulations and welcome to the
                                    <strong>{{ $mailData['companyDetail']->company_name }}</strong> as an administrator!
                                </p>
